...
type SideContextWrapperProps = Omit<React.ComponentProps<"div">, "ref"> & {
  defaultOpen?: boolean;
  open?: boolean;
...
const SideContextWrapperComponent: React.FC<SideContextWrapperProps> = ({
  defaultOpen = true,
  open: openProp,
...
SideContextWrapperComponent.displayName = "SideContextWrapper";

const SideContextWrapper = SideContextWrapperComponent;
  ...
  (
    {
      ...
      className,
      children,
      // Explicitly destructure props that are not meant for the Sheet/Dialog component
      ...divProps // Remaining props are for the desktop div wrapper
    },
    ref
  ) => {
